...
const Login = () => {
    ...
    return (
        <>
            <div className='text-white py-14 text-center container mx-auto'>
            ...
            <div className="social-login-buttons ">
                <div className="flex flex-col gap-2 min-h-screen items-center p-10">
                    ...
                    <button
                        className="flex items-center  w-80 bg-slate-50 border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
